...
void main() {
	...
	blockColor.rgb = mix(blockColor.rgb, vFog.rgb, vFog.a);
	FragmentData data = FragmentData(textureColor, vVertexColor, properties, vFog, worldPos, vLocalOffset, vScreenPos);
